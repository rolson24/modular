...
GPT_OSS_SAFETENSOR_MAP: dict[str, str] = {
    ...
    ".mlp.experts.gate_up_proj_blocks": ".mlp.experts.gate_up_proj",
    ".mlp.experts.gate_up_proj_scales": ".mlp.experts.gate_up_proj_scale",
    ".mlp.experts.down_proj_blocks": ".mlp.experts.down_proj",
    ".mlp.experts.down_proj_scales": ".mlp.experts.down_proj_scale",
    # MoE weight mappings
